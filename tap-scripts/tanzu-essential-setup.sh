...
#mac - https://network.tanzu.vmware.com/api/v2/products/tanzu-cluster-essentials/releases/1180592/product_files/1263761/download
#linux - https://network.tanzu.vmware.com/api/v2/products/tanzu-cluster-essentials/releases/1180592/product_files/1263760/download
...
tanzuessnurl=https://network.tanzu.vmware.com/api/v2/products/tanzu-cluster-essentials/releases/1180592/product_files/1263761/download
...
tanzuessnurl=https://network.tanzu.vmware.com/api/v2/products/tanzu-cluster-essentials/releases/1180592/product_files/1263760/download
mkdir $HOME/tanzu-cluster-essentials
wget $tanzuessnurl --header="Authorization: Bearer ${access_token}" -O $HOME/tanzu-cluster-essentials/$filename
tar -xvf $HOME/tanzu-cluster-essentials/$filename -C $HOME/tanzu-cluster-essentials
